...
mhs_pekerja = MahasiswaPekerja("Dadang Guntara", "210511131", "Programmer")
mhs_pekerja.belajar() # output: Dadang Guntara sedang belajar
mhs_pekerja.bekerja() # output: Dadang Guntara sedang bekerja
mhs_pekerja.bersosialisasi() # output: Dadang Guntara sedang bersosialisasi
